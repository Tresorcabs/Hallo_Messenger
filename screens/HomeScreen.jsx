...
export default function HomeScreen() {
    ...
    <View className="flex-col items-center w-full h-full bg-white">
        ...
        <Animated.Image entering={FadeInUp.delay(200).duration(1000).springify()} className="absolute w-full h-full" source = {require('../assets/images/bg-image.png')}/> 
        
        <View className="flex items-center content-center justify-center w-full h-2/3">
            <Animated.Image entering={FadeInDown.delay(400).duration(1000).springify().dumping} className="pt-10" source = {require('../assets/images/logo.png')}/>
